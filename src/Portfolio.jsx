				...
				<div id="Portfolio">
					...
					<CardColumns>
						...
						{this.state.reactjs || this.state.bootstrap ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Fully functional drum machine. Play using Q W E A S D Z X C keys or clicking the
										buttons directly. Mobile friendly.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.reactjs || this.state.javascript ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/react-js-calculator.jpeg')} />
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/wvKOJVo">Calculator</a>
									</Card.Title>
									<Card.Text>
										Fully functional calculator, build using React.js and vanilla JavaScript. Mobile
										friendly.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.javascript ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Temperature Evolution 1753-2015 using D3 JavaScript's library for Data Analysis.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.javascript || this.state.reactjs ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/react-js-pomodoro-clock.jpeg')} />
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/JjYzwma">Pomodoro Clock</a>
									</Card.Title>
						...
						{this.state.javascript || this.state.reactjs ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/react-js-markdown-prev.jpeg')} />
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/vYNadrw">Markdown Previewer</a>
									</Card.Title>
									<Card.Text>
						...
						{this.state.javascript || this.state.reactjs ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/react-quotemachine.jpeg')} />
								<Card.Body>
									<Card.Title>
									...
									<Card.Text>
										I took the typical random quote generator idea and spiced it up a bit, fetching
										an old League of Legends' API.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
									<small className="text-muted">React.js + JavaScript</small>
						...
						{this.state.html || this.state.css ? (
							<Card>
								...
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/ExVjPYK">Documentation Page</a>
									</Card.Title>
									<Card.Text>
										Sample documentation page using plain HTML & CSS. You can take a look at it if
										you're interested in nutrition. The info is accurate, actually.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
									<small className="text-muted">HTML + CSS</small>
						...
						{this.state.javascript ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Prevalence of Doping in Cyclism 1994-2015. An example of JavaScript's D3 library
										for Data Analysis.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.html || this.state.css ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Simple survey form example for a fitness business. Do you want to get fit? What
										are your goals? How can we help you?
									</Card.Text>
								</Card.Body>
								<Card.Footer>
									<small className="text-muted">HTML + CSS</small>
						...
						{this.state.javascript ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/us-choropleth-education.jpeg')} />
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/KKVKKRm">Choropleth Map</a>
									</Card.Title>
									<Card.Text>
										United States Educational Attainment. Percentage of adults age 25 and older with
										a bachelor's degree or higher (2010-2014). An example of JavaScript's D3 library
										for Data Analysis.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.javascript ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/video-game-sales.jpeg')} />
								<Card.Body>
									<Card.Title>
										<a href="https://codepen.io/gerardcsaperas/pen/RwrwMqX">Tree Map</a>
									</Card.Title>
									<Card.Text>
										Video Game Sales. Top 100 Most Sold Video Games Grouped by Platform. An example
										of JavaScript's D3 library for Data Analysis.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
									<small className="text-muted">JavaScript</small>
						...
						this.state.bootstrap ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Full Stack MERN website. A sold website for a take-away restaurant based in
										Barcelona. Fully functional website accepting orders and payments. Taking into
										account the day of the week, the number of orders recieved for a single day,
										etc.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.nodejs ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										Back End project for pure practice. The main goal was to get a timestamp in unix
										and Date object format from a date string.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.nodejs ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										More Back End practice. I can upload a file and get its details through server
										side code.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.nodejs || this.state.mongodb ? (
							<Card>
								...
								<Card.Body>
									<Card.Title>
										<a href="https://glitch.com/edit/#!/private-brazen-washer">URL Shortener</a>
									</Card.Title>
									<Card.Text>
										I can introduce a link and it gets uploaded in a database and related to a
										unique number (which is the short key binding for the url).
									</Card.Text>
								</Card.Body>
								<Card.Footer>
						...
						{this.state.nodejs ? (
							<Card>
								...
								<Card.Body>
									...
									<Card.Text>
										I can get the IP address, preferred languages and system infos from your device.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
									<small className="text-muted">Node.js + Express</small>
						...
						{this.state.nodejs || this.state.mongodb ? (
							<Card>
								<Card.Img variant="top" src={require('./assets/images/exercise-tracker.jpeg')} />
								<Card.Body>
									<Card.Title>
									...
									<Card.Text>
										I can create a new user, register exercises (and their details) and retrieve my
										logs upon request.
									</Card.Text>
								</Card.Body>
								<Card.Footer>
